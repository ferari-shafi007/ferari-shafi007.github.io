...
const geometry = new THREE.CylinderGeometry(1.5, 1.5, 1.35, 32, 1, true);
...
// re position the object to better view the model
cylender.position.y = 1.5;
// cylender.rotation.x = Math.PI / 2;
cylender.rotation.z = Math.PI / 0.48;
